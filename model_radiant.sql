...
CREATE INDEX IF NOT EXISTS idx_case_performer_lab_id ON "case" ("performer_lab_id");
CREATE INDEX IF NOT EXISTS idx_case_priority ON "case" ("priority");
...
CREATE TABLE IF NOT EXISTS "task" (
    "id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    "type" INTEGER REFERENCES "task_types" ("code") NOT NULL,
